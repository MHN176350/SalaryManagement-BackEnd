...
namespace Project.Controllers
{
    ...
    public class ContractController : ODataController
    {
        ...
        {
            var checkEmployeeTypeIsDefined = !System.Enum.IsDefined(typeof(EnumList.EmployeeType), req.EmployeeType);
            var checkSalaryTypeIsDefined = !System.Enum.IsDefined(typeof(EnumList.SalaryType), req.SalaryType);
