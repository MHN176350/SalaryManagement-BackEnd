...
namespace Project.Controllers
{
    ...
    public class EmployeeController : ODataController
    {
        ...
        {
            var checkGenderIsDefined = !System.Enum.IsDefined(typeof(EnumList.Gender), employee.Gender);
            if (checkGenderIsDefined) return BadRequest("Role or Gender is not defined");
            var checkAgeOfEmployeeLessThan18 = AutoEmployee.CheckAgeLessThan18(employee.Dob);
